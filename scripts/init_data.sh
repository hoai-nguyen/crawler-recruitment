...
declare -a pages=("topdev" "topcv" "itviec" "mywork" "timviecnhanh" "vieclam24h" "findjobs" "careerlink" "laodong" "timviec365" "tuyencongnhan" "tuyendungsinhvien" "tuyendungcomvn" "itguru")
